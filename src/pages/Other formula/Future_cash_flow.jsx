...
const Future_cash_flow = () => {

    const { setFutureCashFlowData } = useData();
    ...
    return (
        <>
            <div>
                ...
                <div>
                    <label>Cash from Operating Activites:
...
export default Future_cash_flow;
